...
async def about(ctx):
    await ctx.message.delete()
    embed = discord.Embed(title="Crystal Selfbot", description="Crystal SelfBot is an open source, easy to use, customizable selfbot. It was made by xxTurborocketxx#0001", color=0x9F00FB)
    embed.set_thumbnail(url="https://media.giphy.com/media/Q5w2ItO7cdzFe/giphy.gif")
    embed.set_footer(text="Crystal")
    text = await ctx.send(embed=embed)
